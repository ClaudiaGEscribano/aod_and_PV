...
one <- stack("../../proj12abr/oneAxis_caer_yearlyProd_temp_20032009.grd")
...
bsrn_oneY_caer <- extract(one, bsrnlonlat, method="simple")
save(bsrn_oneY_caer, file='bsrn_oneY_caer.Rdata')

##########################################################
## CNO
#########################################################
 
oneno <- stack("../../proj12abr/oneAxis_cno_yearlyProd_temp_20032009.grd")
idx <- seq(as.Date("2003-01-01"), as.Date("2009-12-31"), 'year')
...
bsrn_oneY_cno <- extract(oneno, bsrnlonlat, method="simple")
save(bsrn_oneY_cno, file='bsrn_oneY_cno.Rdata')

##########################################################
## SAT
#########################################################

onesat <- stack("../../proj12abr/oneAxis_sat_yearlyProd_temp_20032009.grd")
idx <- seq(as.Date("2003-01-01"), as.Date("2009-12-31"), 'year')
...
bsrn_oneY_sat <- extract(onesat, SpatialPoints(cbind(lon, lat)))
save(bsrn_oneY_sat, file='bsrn_oneY_sat.Rdata')
