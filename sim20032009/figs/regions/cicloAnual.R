...
pdf('carpentraCiclofixed.pdf')
xyplot(carpentras, lwd=2,superpose=TRUE, xlab='months', ylab='[kWh/kWp]')
dev.off()
...
pdf('sedebrokerCiclofixed.pdf')
xyplot(sedebroker, lwd=2, superpose=TRUE, xlab='months', ylab='[kWh/kwp]')
dev.off()
...
pdf('payerneCiclofixed.pdf')
xyplot(payerne, lwd=2, superpose=TRUE, xlab='months', ylab='[kWh/kWp]')
dev.off()
